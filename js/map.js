    ...
    floors: {
      3: {
        ...
        rooms: [
          ...
          { id: "as357", name: "AS357", organisations: [{ name: "Language Exchange Circle", category: "academic" }] },
          { id: "as365", name: "AS365", organisations: [{ name: "Basketball Club", category: "sports" }] },
          { id: "as356", name: "AS356", organisations: [{ name: "International Volunteers", category: "volunteering" }] },
          { id: "as364", name: "AS364", organisations: [{ name: "Photography Society", category: "culture" }] },
          { id: "as363", name: "AS363", organisations: [{ name: "Economics Study Group", category: "academic" }] },
          { id: "as362", name: "AS362", organisations: [{ name: "Tennis Club", category: "sports" }] },
          { id: "as361", name: "AS361", organisations: [{ name: "Community Support Group", category: "volunteering" }] },
          { id: "ps-lounge", name: "PS Lounge", organisations: [{ name: "Student Support Team", category: "volunteering" }] },
          { id: "ac348", name: "AC348", organisations: [{ name: "Programming Circle", category: "academic" }] },
          ...
          { id: "ac345", name: "AC345", organisations: [{ name: "Debate Society", category: "academic" }] },
          { id: "ac336", name: "AC336", organisations: [{ name: "Film Appreciation Circle", category: "culture" }] },
          { id: "ac344", name: "AC344", organisations: [{ name: "Environmental Volunteers", category: "volunteering" }] },
          { id: "ac343", name: "AC343", organisations: [{ name: "Table Tennis Club", category: "sports" }] },
          { id: "ac342", name: "AC342", organisations: [{ name: "Research Association", category: "academic" }] },
          { id: "ac341", name: "AC341", organisations: [{ name: "Traditional Music Circle", category: "culture" }] },
          { id: "ba-house", name: "BA House", organisations: [{ name: "Business Administration Society", category: "academic" }] },
          ...
          { id: "an325", name: "AN325", organisations: [{ name: "Academic Research Society", category: "academic" }] },
          { id: "an324", name: "AN324", organisations: [{ name: "Local Community Volunteers", category: "volunteering" }] },
          ...
          { id: "an322", name: "AN322", organisations: [{ name: "Literature Circle", category: "culture" }] },
          {
            ...
            name: "AN321",
            organisations: [
              { name: "Organisation A", category: "academic" },
              { name: "Organisation B", category: "volunteering" }
            ]
          },
          { id: "an316", name: "AN316", organisations: [{ name: "Media Production Circle", category: "culture" }] },
          { id: "student-lounge", name: "Student Lounge", organisations: [{ name: "Student Volunteer Network", category: "volunteering" }] },
          { id: "ac330", name: "AC330", organisations: [{ name: "Technology Research Group", category: "academic" }] },
